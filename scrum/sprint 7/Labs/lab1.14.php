...
Aantal:
    ...
    ?>
        ...
        <div class="genre">
        <input type="text" size=2 maxlength=3 name="Genre" class="aantal" value="Genre">  
        <input type="text" size=5 maxlength="" name="artiest" class="aantal" value="Artiest"> 
        <input type="text" size=5 maxlength="" name="album" class="aantal" value="Album">   
        <input type="text" size=2 maxlength="" name="aantal" class="aantal" value="Aantal">   
        <input type="text" size=2 maxlength="" name="prijs" class="aantal" value="Prijs">   
        <input type="text" size=2 maxlength="" name="bedrag" class="aantal" value="bedrag">   
        </body>
        </div>
        <div class="div1">
        <input type="text" size=2 maxlength=3 name="Genre" class="" value="World">  
        <input type="text" size=10 maxlength="5" name="artiest" class="" value="Cesaria Evora"> 
        <input type="text" size=5 maxlength="" name="album" class="" value="Em Um Concerto">   
        <input type="text" size=2 maxlength="" name="aantal" class="" value="1">   
        <input type="text" size=2 maxlength="" name="prijs" class="" value="9">   
        <input type="text" size=2 maxlength="" name="bedrag" class="" value="9.00"> 
        </div>
</html>